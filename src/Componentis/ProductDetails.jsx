...
import 'react-toastify/dist/ReactToastify.css'; // Toastify CSS faylini import qilamiz
...
export default function ProductDetails() {
  ...
  const handleSendMessage = async () => {
    if (!name.trim() || !phone.trim()) {
      toast.error("Iltimos, barcha maydonlarni to'ldiring."); // Xato holatida tostdan foydalanamiz
      return;
    }
    ...
    try {
      ...
      if (data.ok) {
        toast.success("Xabar yuborildi!"); // Muvaffaqiyatli holatda tost
        setShowModal(false);
        setName('');
        setPhone('');
        setQuantity(0);
        ...
        <div className="flex flex-col justify-between p-4">
          ...
          <div className="flex items-start gap-4 flex-col my-6">
            ...
            <div className='flex'>
              ...
              <button 
                className="py-2 px-4 bg-secondary hover:bg-gray-300 rounded ml-4" 
