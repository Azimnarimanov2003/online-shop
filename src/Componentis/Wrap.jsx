...
export default function Wrap() {
  return (
    <div className="p-4  section max-w-[1200px]">
   
        <ul className="space-y-6   border-b-2 p-12"  >
          ...
          <li className='flex flex-wrap gap-4 lg:justify-between'>
            <div className="w-40 sm:w-40 md:w-40 lg:w-40 h-40 flex flex-col items-center justify-center bg-white border border-gray-300 rounded-lg shadow-md hover:bg-red-500 hover:text-white transition-colors duration-300 ease-in-out">
            ...
            <div className="w-40 sm:w-40 md:w-40 lg:w-40 h-40  flex flex-col items-center justify-center bg-white border border-gray-300 rounded-lg shadow-md hover:bg-red-500 hover:text-white transition-colors duration-300 ease-in-out">
              <img src={img4} alt="logo" className="w-24 h-24 mb-2 rounded-t-lg filter brightness-0" />
              <h5 className="text-gray-800 text-center mt-2 transition-colors duration-300 ease-in-out hover:text-white">
                Camera
              </h5>
            </div>
